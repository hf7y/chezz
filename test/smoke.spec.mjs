...
// LEADERBOARD_URL is now relative, so under file:// Chromium's Fetch API
// refuses it outright ("URL scheme ... is not supported") instead of the
// network-error noise other paths produce. Expected under file://, not a bug.
